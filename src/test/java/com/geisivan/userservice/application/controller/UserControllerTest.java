...
class UserControllerTest {
    ...
    @Test
    void findAuthenticatedUser_shouldReturn200_whenUserExists() throws Exception {
    ...
    @Test
    void findAuthenticatedUser_shouldReturn404_whenUserDoesNotExist() throws Exception {
